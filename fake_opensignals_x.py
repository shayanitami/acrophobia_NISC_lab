...
FILE = r"C:\Users\Shayan\Desktop\NICS\acrophobia\shayan_code\vret_pipeline\VAR_mylaptop_test_opensignals_0007800F319C_2026-05-29_14-52-05.txt"
...
for i in range(rows):
    ...
    time.sleep(0.001)
print(f"[done] reached end of recording ({rows} samples, {rows/1000:.1f}s). "
      f"Stream finished — no more samples will be sent.")
